   ...
   // @available(iOS 8.0, *)
    ...
    init(codeTypes: [AVMetadataObject.ObjectType],videoPreView: UIView, prepareTxt: String = "设备准备中...") {
        ...
        if session.canAddOutput(metadataOutput) {
            ...
            metadataOutput.metadataObjectTypes = [AVMetadataObject.ObjectType.qr,AVMetadataObject.ObjectType.ean8, AVMetadataObject.ObjectType.ean13, AVMetadataObject.ObjectType.pdf417]//codeTypes
